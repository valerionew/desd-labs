...
namespace eval ::optrace {
  variable script "C:/Users/valer/Documents/desd-labs/LAB1_C3/LAB1_C3.runs/impl_1/TOP_KIT.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Users/valer/Documents/desd-labs/LAB1_C3/LAB1_C3.runs/synth_1/TOP_KIT.dcp
...
OPTRACE "link_design" START { }
  link_design -top TOP_KIT -part xc7a35tcpg236-1
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force TOP_KIT_opt.dcp
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force TOP_KIT_placed.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force TOP_KIT_routed.dcp
...
if {$rc} {
  write_checkpoint -force TOP_KIT_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi TOP_KIT.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force TOP_KIT.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force TOP_KIT}
  catch {file copy -force TOP_KIT.ltx debug_nets.ltx}
