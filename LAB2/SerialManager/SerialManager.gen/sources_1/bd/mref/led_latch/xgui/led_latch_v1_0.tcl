...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NUM_BOARD_LEDS" -parent ${Page_0}
...
proc update_PARAM_VALUE.NUM_BOARD_LEDS { PARAM_VALUE.NUM_BOARD_LEDS } {
	# Procedure called to update NUM_BOARD_LEDS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUM_BOARD_LEDS { PARAM_VALUE.NUM_BOARD_LEDS } {
	# Procedure called to validate NUM_BOARD_LEDS
	return true
}
...
proc update_MODELPARAM_VALUE.NUM_BOARD_LEDS { MODELPARAM_VALUE.NUM_BOARD_LEDS PARAM_VALUE.NUM_BOARD_LEDS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUM_BOARD_LEDS}] ${MODELPARAM_VALUE.NUM_BOARD_LEDS}
}
