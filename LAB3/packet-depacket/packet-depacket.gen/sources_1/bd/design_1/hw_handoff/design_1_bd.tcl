...
connect_bd_intf_net -intf_net [get_bd_intf_nets AXI4Stream_UART_0_M00_AXIS_RX] [get_bd_intf_pins AXI4Stream_UART_0/M00_AXIS_RX] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net depacketizer_0_M_AXIS [get_bd_intf_pins depacketizer_0/M_AXIS] [get_bd_intf_pins packetizer_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets depacketizer_0_M_AXIS] [get_bd_intf_pins depacketizer_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets packetizer_0_M_AXIS] [get_bd_intf_pins packetizer_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets packetizer_0_M_AXIS]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AXI4Stream_UART_0/clk_uart] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aclk] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins depacketizer_0/CLK] [get_bd_pins packetizer_0/CLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aresetn] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aresetn] [get_bd_pins depacketizer_0/RESETN] [get_bd_pins packetizer_0/RESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
